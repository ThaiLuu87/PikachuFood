...
- **Regen:** mỗi 45s sinh thêm tối đa 7 cặp vào vùng trống (chỉ sinh vừa số ô trống; tới 18 đợt, dừng sau giây 200). Chỉ **thua (tràn lưới)** khi lưới đầy hoàn toàn lúc tới kỳ regen.
...
- **Thắng:** dọn sạch lưới trước khi hết **5 phút 30 giây**. **Thua:** hết giờ còn ô, hoặc tràn lưới.
- ⚠️ **God Mode:** calibrate (mô phỏng) để chỉ thắng nếu giữ nhịp **~2.6 giây/cặp** suốt màn dưới áp lực regen + đổi hướng + băng.
