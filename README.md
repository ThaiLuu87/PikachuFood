...
- **Regen:** mỗi 19s sinh thêm 7 cặp vào vùng trống (tới 18 đợt, dừng sau giây 180). Tới kỳ regen mà hết chỗ → **thua** (tràn lưới).
...
- **Thắng:** dọn sạch lưới trước khi hết **3.5 phút**. **Thua:** hết giờ còn ô, hoặc tràn lưới.
- ⚠️ **God Mode:** calibrate (mô phỏng) để chỉ thắng nếu giữ nhịp **~1.3 giây/cặp** suốt màn dưới áp lực regen + đổi hướng + băng.
