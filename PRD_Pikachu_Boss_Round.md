...
Các giá trị dưới đây (có thêm cơ chế **đổi hướng gravity** + **ô băng**) được tinh chỉnh để màn **chỉ thắng nếu giữ nhịp ~3 giây/cặp**; chậm hơn ~3.1s/cặp là thua. Mô phỏng: nhịp ≤3.0s/cặp → thắng; ≥3.1s/cặp → thua. Xem thêm `docs/superpowers/specs/2026-05-31-god-mode-mechanics-design.md`.
...
| Nhịp mục tiêu (để thắng) | **~3 giây/cặp** |
| Giới hạn 3 đoạn | Có |
