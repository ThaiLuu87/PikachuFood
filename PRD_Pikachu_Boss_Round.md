...
Các giá trị dưới đây (có thêm cơ chế **đổi hướng gravity** + **ô băng**) được tinh chỉnh để màn **chỉ thắng nếu giữ nhịp ~1.3 giây/cặp**; chậm hơn ~1.4s/cặp là thua. Mô phỏng: nhịp ≤1.3s/cặp → thắng; ≥1.4s/cặp → thua. Xem thêm `docs/superpowers/specs/2026-05-31-god-mode-mechanics-design.md`.
...
| Cặp ban đầu | 96 |
| Loại hình | 24 |
| Thời gian | **210 giây** (3.5 phút) |
| Hướng gravity | Đổi mỗi đợt regen (4 góc), telegraph 5s |
| Chu kỳ regen | **19 giây** |
| Số cặp mỗi đợt regen | **7 cặp (14 ô)** |
| Cap số đợt regen | **18 đợt** |
| Ngừng regen sau giây thứ | **180** (30s cuối không regen) |
