...
Các giá trị dưới đây (có thêm cơ chế **đổi hướng gravity** + **ô băng**) được tinh chỉnh để màn **chỉ thắng nếu giữ nhịp ~1.9 giây/cặp**; chậm hơn ~2.0s/cặp là thua. Mô phỏng: nhịp ≤1.9s/cặp → thắng; ≥2.0s/cặp → thua. Xem thêm `docs/superpowers/specs/2026-05-31-god-mode-mechanics-design.md`.
...
| Nhịp mục tiêu (để thắng) | **~1.9 giây/cặp** |
| Giới hạn 3 đoạn | Có |
