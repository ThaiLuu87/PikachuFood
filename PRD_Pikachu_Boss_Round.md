...
Các giá trị dưới đây (có thêm cơ chế **đổi hướng gravity** + **ô băng**) được tinh chỉnh để màn **chỉ thắng nếu giữ nhịp ~2.6 giây/cặp**; chậm hơn ~2.7s/cặp là thua. Mô phỏng: nhịp ≤2.6s/cặp → thắng; ≥2.7s/cặp → thua. Xem thêm `docs/superpowers/specs/2026-05-31-god-mode-mechanics-design.md`.
...
| Nhịp mục tiêu (để thắng) | **~2.6 giây/cặp** |
| Giới hạn 3 đoạn | Có |
