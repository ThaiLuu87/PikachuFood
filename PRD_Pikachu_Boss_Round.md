...
## 12. Số liệu cấu hình (tóm tắt để tinh chỉnh)
...
| Số cặp mỗi đợt regen | 6 cặp (12 ô) |
| Cap số đợt regen | 6 đợt |
| Ngừng regen sau giây thứ | 360 (120s cuối không regen) |
| Cảnh báo trước regen | 5 giây |
| Auto-shuffle khi bế tắc | Bật, miễn phí, không giới hạn |
| Nhịp mục tiêu | ~3.0–3.5 giây/cặp |
| Giới hạn 3 đoạn | Có |
