...
- **Sinh vừa chỗ trống:** mỗi đợt chỉ sinh số cặp vừa với số ô trống đang có (tối đa REGEN_PAIRS). KHÔNG instakill chỉ vì lưới còn ít chỗ.
- **Tràn lưới:** chỉ **thua ngay** khi đến kỳ regen mà lưới **đầy hoàn toàn (0 ô trống)** — tức người chơi gần như không dọn được gì. (Trước đây đòi đủ 14 ô trống nên thua oan ngay đợt đầu ở giây 24 khi lưới khởi đầu kín — đã sửa.)
...
Các giá trị dưới đây (có thêm cơ chế **đổi hướng gravity** + **ô băng**) được tinh chỉnh để màn **chỉ thắng nếu giữ nhịp ~2.1 giây/cặp**; chậm hơn ~2.2s/cặp là thua. Mô phỏng: nhịp ≤2.1s/cặp → thắng; ≥2.2s/cặp → thua. Xem thêm `docs/superpowers/specs/2026-05-31-god-mode-mechanics-design.md`.
...
| Cặp ban đầu | 96 |
| Loại hình | 24 |
| Thời gian | **265 giây** (~4.5 phút) |
| Hướng gravity | Đổi mỗi đợt regen (4 góc), telegraph 6s |
| Chu kỳ regen | **45 giây** |
| Số cặp mỗi đợt regen | **7 cặp (14 ô)** |
| Cap số đợt regen | **18 đợt** |
| Ngừng regen sau giây thứ | **200** (40s cuối không regen) |
| Ô băng ban đầu / mỗi regen | **8 / 2** |
| Cảnh báo trước regen | 6 giây |
| Auto-shuffle khi bế tắc | Bật, miễn phí (tan hết băng trước) |
| Nhịp mục tiêu (để thắng) | **~2.1 giây/cặp** |
| Giới hạn 3 đoạn | Có |
